...
namespace PHPSTORM_META {
    ...
    * Generated on 2018-03-19 09:49:28.
    *
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'bootstrapper::accordion' => \Bootstrapper\Accordion::class,
        'bootstrapper::alert' => \Bootstrapper\Alert::class,
        'bootstrapper::badge' => \Bootstrapper\Badge::class,
        'bootstrapper::breadcrumb' => \Bootstrapper\Breadcrumb::class,
        'bootstrapper::buttongroup' => \Bootstrapper\ButtonGroup::class,
        'bootstrapper::button' => \Bootstrapper\Button::class,
        'bootstrapper::carousel' => \Bootstrapper\Carousel::class,
        'bootstrapper::config' => \Bootstrapper\Bridges\Config\Laravel5Config::class,
        'bootstrapper::dropdownbutton' => \Bootstrapper\DropdownButton::class,
        'collective::html' => \Collective\Html\HtmlBuilder::class,
        'bootstrapper::form' => \Bootstrapper\Form::class,
        'bootstrapper::icon' => \Bootstrapper\Icon::class,
        'bootstrapper::image' => \Bootstrapper\Image::class,
        'bootstrapper::inputgroup' => \Bootstrapper\InputGroup::class,
        'bootstrapper::helpers' => \Bootstrapper\Helpers::class,
        'bootstrapper::label' => \Bootstrapper\Label::class,
        'bootstrapper::mediaobject' => \Bootstrapper\MediaObject::class,
        'bootstrapper::modal' => \Bootstrapper\Modal::class,
        'bootstrapper::navbar' => \Bootstrapper\Navbar::class,
        'bootstrapper::navigation' => \Bootstrapper\Navigation::class,
        'bootstrapper::panel' => \Bootstrapper\Panel::class,
        'bootstrapper::progressbar' => \Bootstrapper\ProgressBar::class,
