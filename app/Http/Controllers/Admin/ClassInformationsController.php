...
class ClassInformationsController extends Controller
{
   /**
    ...
    {
        $class_informations = ClassInformation::paginate(10);
    ...
    public function create()
    {
        $form = \FormBuilder::create(ClassInformationForm::class, [
            'url' => route('class_informations.store'),
            'method' => 'POST'
        ]);
    ...
    public function store(Request $request)
    {
        ...
        $request->session()->flash('message','Classe criada com sucesso');
    ...
    public function update(ClassInformation $class_information)
    {
        ...
        session()->flash('message','Classe editada com sucesso');
        return redirect()->route('class_informations.index');
    }
